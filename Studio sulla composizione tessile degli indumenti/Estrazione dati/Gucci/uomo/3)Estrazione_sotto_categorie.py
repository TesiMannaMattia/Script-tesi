...
df=pd.read_csv("/Users/mattia/Library/Mobile Documents/com~apple~CloudDocs/Tesi/Codici/Scraping Gucci/1) Estrazione dati/Uomo/LINK:HTML/link_categorie.csv")
...
for i,row in df.iterrows():
    if row["Categoria"]=="Activewear" or row["Categoria"]=="Costumi da Bagno":
...
new_data.to_csv("/Users/mattia/Library/Mobile Documents/com~apple~CloudDocs/Tesi/Codici/Scraping Gucci/1) Estrazione dati/Uomo/LINK:HTML/link_sottocategorie.csv")
