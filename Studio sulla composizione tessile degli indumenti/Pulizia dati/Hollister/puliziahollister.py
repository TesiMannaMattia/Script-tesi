...
df = pd.read_csv('/Users/mattia/Library/Mobile Documents/com~apple~CloudDocs/Tesi/Dati/Dati grezzi (NON MODIFICARE!)/Hollister.csv')
...
"""
altro=[ 'GRIGIO E NERO',
  'BIANCO A RIGHE E GRIGIO',
  'LAVAGGIO SCURO ACCESO',
'LAVAGGIO MEDIO ACCESO CON STRAPPI',
 'LAVAGGIO CHIARO CON STRAPPI E RAMMENDI',
  'EFFETTO LAVAGGIO CHIARO',
  'MEDIA',
  'LAVAGGIO CHIARO ACCESO',
  'LIGHT RIPPED WASH',
 'LAVAGGIO CHIARO ACCESO CON STRAPPI',
  'LAVAGGIO MEDIO ACCESO',
  'LAVAGGIO SCURO CON STRAPPI E RAMMENDI',
  'SHREDDED DARK WASH',
  'LAVAGGIO SUPER CHIARO',
 'LAVAGGIO SCURO CON RAMMENDI',
  'LAVAGGIO CHIARO ACCESO CON VERNICE',
 'MEDIO ACCESO',
 'LAVAGGIO EXTRACHIARO CON STRAPPI',
 'LIGHT WASH WITH BLEACH',
 'LAVAGGIO SUPER CHIARO CON STRAPPI',  'CAMO',
  'GREY AND WHITE',
  'LIGHT BROWN TO BLACK OMBRE',
  'NAVY TO BLUE OMBRE',
  'BLACK TO BURGUNDY OMBRE',
 'GREY TO BLACK OMBRE', 'SFUMATO DA NERO A ROSA',
 'DA AZZURRO A SFUMATO NERO',
  'SFUMATO DA BIANCO A GRIGIO',
  'NERO-BIANCO-GRIGIO MÉLANGE',
  'DA NERO A SFUMATO VERDE CHIARO',
 'SFUMATO DA GRIGIO SCURO A NERO',
  'SFUMATO DA ROSSO A NERO',
  'SFUMATO DA BLU A NERO',
  'SFUMATO DA NERO A BIANCO',
  'SFUMATO DA NERO AD AZZURRO',
  'DA NERO A COLOR MENTA',
 'DA NERO A BIANCO','BLU GRIGIO SCURO','ROSSO ARANCIONE','BACCA','LAVAGGIO CHIARO CON VERNICE','RINSE','EFFETTO GRIGIO EFFETTO TINTURA','SCURO CON STRAPPI','LAVAGGIO MEDIO CHIARO CON STRAPPI','LAVAGGIO MEDIO CHIARO','LAVAGGIO MEDIO A RIGHE','DARK RINSE','LIGHT DESTROYED WASH','LAVAGGIO MEDIO SCURO CON STRAPPI', 'LAVAGGIO CHIARO DISTRUTTO','LAVAGGIO MEDIO CON CINTURA','DARK RIPPED WASH','LAVAGGIO MEDIO CON STRAPPI SULLE GINOCCHIA','RINSE SCURO','DISTRUTTO CHIARO','LAVAGGIO MEDIO SCURO','RINSE LEGGERMENTE STRAPPATI','LAVAGGIO MEDIO CON RAMMENDI','LAVAGGIO MEDIO DISTRUTTO','LAVAGGIO SCURO MEDIO','LAVAGGIO CHIARO CON STRAPPI','LAVAGGIO MEDIO CON STRAPPI SCURO', 'LAVAGGIO MEDIO STAMPATO','LAVAGGIO MEDIO','LAVAGGIO CHIARO MEDIO','MEDIO CON RAMMENDI', 'LAVAGGIO SCURO CON STRAPPI','LAVAGGIO CHIARO','CHIARO SBIADITO E FONDO SEMPLICE','LAVAGGIO SCURO','CHIARO DISTRUTTO','LAVAGGIO MEDIO CON STRAPPI', 'DISTRUTTO SCURO','SCURO','MEDIO DISTRUTTO','DISTRUTTO SCURO CON FONDO SFRANGIATO','MEDIO','A FIORI ARANCIONI','VERDE E BLU NAVY', 'MARRONE-BIANCO', 'STAMPA ZEBRATA', 'BLU VIOLA CHIARO', 'MULTICOLORE A FIORI', 'BEIGE E NERO', 'Nude', 'MULTI DD', 'BLU NAVY - GRIGIO - BIANCO', 'Altro', 'MULTI', 'BLACK AND WHITE', 'NERO MARRONE CON STAMPA', 'Orange-red/Wisconsin', 'MULTICOLORE', 'BLU VIOLA', 'BIANCO - ROSSO - AZZURRO - SALVIA - NERO', 'BLU GRIGIO', 'WHITE-BLACK', 'Stampa', 'RIGHE MARRONI E ROSSE', 'NERO E ROSSO', 'NERO-BIANCO-GRIGIO', 'MULTI LOGO', 'SCOZZESE MULTI', 'Multicolor', 'BLU NAVY E BIANCO', 'MIX PRIDE', 'NERO E BORDEAUX', 'BIANCO-VERDE', 'BLU-GRIGIO-NERO', 'NERO E CORALLO', 'BLU E BIANCO', 'MIX BASIC', 'BIANCO E NERO', 'VIOLA GRIGIO', 'STAMPA MIMETICA', 'NERO - BIANCO', 'MULTI ICON', 'GRIGIO MÉLANGE E BIANCO', 'BLACK AND GREY', 'Bicolore', 'NERO E GRIGIO', 'Fantasia', 'BLACK AND GREEN', 'BIANCO - GRIGIO MÉLANGE - NEROBIANCHI CON RIGHE GRIGIE', 'STAMPA SCURA', '\tLAVAGGIO MEDIO STAMPATO', 'CHIARO', 'BIANCO - BLU NAVY - ROSSO - BORDEAUX - NERO', 'BLU NAVY-BIANCO-ROSSO', 'Verde-giallo', 'NERO E BIANCO', 'VIOLA BLU', 'ARANCIONE MARRONE', 'SCOZZESE BLU-GRIGIO', 'MULTI CREW', 'WHITE - LIGHT BLUE - GREY - RED - BLACK', 'Grigio chiaro mélange/fantasia', 'WHITE AND BLACK', 'TIE-DYE MULTICOLORE', 'Militare', 'BLACK-WHITE', 'BIANCO-GRIGIO-ROSA', 'NERO E GIALLO', 'MULTI RIGHE']
...
for i in range(0,len(df)):
  if df["Colore"][i].strip() in arancione: #1
  ...
  elif df["Colore"][i].strip() in ecru:
    df["Colore"][i]="Ecru"
    
    
  elif df["Colore"][i].strip() in da_stabilire:
    da_stabilire.append(df["Colore"][i].strip())
    df["Colore"][i]="Da_stabilire"
    n_da_stabilire += 1
   
  elif df["Colore"][i].strip() in altro:
    altroo.append(df["Colore"][i].strip())
    df["Colore"][i]="Altro"
    n_altro +=1 
    ...
    n_da_eliminare += 1
    if df["Colore"][i].strip() not in assenti :
        assenti.append(df["Colore"][i].strip())  
        n+= 1 
        with open("/Users/mattia/Desktop/riepilogo_colori_Hollister.txt","a") as f:
...
""" # Esportazione dati"""
#dati.to_csv("/Users/mattia/desktop/pulito_Hollister.csv")





dati.to_csv('/Users/mattia/Library/Mobile Documents/com~apple~CloudDocs/Tesi/Dati/Dati puliti/pulito_Hollister.csv')
